...
# Download the proteome file of your interest.
# Locally install Phobius1.1, signalp4.1 and interproscan-5 software
# Download, install, and create HMMER3.1 environment using conda, and create a conda environment for it (Like HMM). This will help you create your own HMM profilesand filtering protiens with your target HMM profile
# You can find the HMMER.yml file in the main directory
# Download Pfam33.0 and perform hmmpress using HMMEr3.12 on Pfam.hmm   
# Download and create a conda environemnt for seqtk 
# Extract c2-C3-F region from your multiple seqence alignment and create a C2-C3F-HMM profile using HMMER software
# Download Pfam database and store it
# Create text files enlisting Pfam profile ids for respective domains of RLKs, NLRs and LRRs (I have added the files, you can use them)
# Create IPS_annotation/your preferred conda environment and install >java 11. and activate this environment while running Interproscan software

# Path variables ditected towards different directories, datasets, and software.
output='~/output/Athout' # path to your output file
genome='~/IPS/genome.proteins/Athaliana/Athaliana_Araport.primaryTransc.fasta' # path to your input proteome file
c3c2f='~/Pfam/NC2C3.hmm' # path to your C2-C3F constructed HMMfile
pfam='~/Pfam' # path to downloaded Pfam database.
signalp='~/scripts/signalp-4.1/signalp' # path to your localy installed signalp4.1 software
phobius='~/phobius/phobius.pl' # path to your localy installed phobius software
ips='~/IPS/interproscan-5.65-97.0/interproscan.sh' # path to your localy installed interproscan
